...
cd src/_tealet
rm -rf libtealet
curl -L https://github.com/kristjanvalur/libtealet/releases/download/v0.7.6/libtealet-0.7.6.tar.gz | tar -xz
mkdir -p libtealet
mv LICENSE Makefile README.md lib stackman tealet libtealet/
```

For a different version, replace `v0.7.6` and `libtealet-0.7.6` in the URL.
