...
Built on vendored libtealet release archives (currently v0.7.3), this library offers:
...
- **[libtealet](https://github.com/kristjanvalur/libtealet) v0.7.3** - Core stack-slicing library (pre-built binaries in `src/_tealet/libtealet/lib/`)
