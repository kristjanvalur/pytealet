...
if "greenlet.tests" not in sys.modules:
    sys.modules["greenlet.tests"] = sys.modules[__name__]

import greenlet as _greenlet_module
if not hasattr(_greenlet_module, "GREENLET_USE_GC"):
    # Placeholder for upstream flag until a dedicated _greenlet emulation
    # exists.
