...
def test_ring_statx_path_returns_size_in_result_and_buffer_when_available():
    require_uring()
...
def test_ring_statx_fd_submit_returns_size_in_result_and_buffer_when_available():
    require_uring()
