...
static const UringApi_CAPI uring_api_capi_table = {
    ...
    UringApiCapi_RingConstructRecv,
    UringApiCapi_RingConstructRecvBuf,
    UringApiCapi_RingConstructRecvMultishot,
    UringApiCapi_RingConstructSend,
    UringApiCapi_RingConstructSendZc,
    UringApiCapi_RingConstructRecvmsg,
    UringApiCapi_RingConstructSendto,
    UringApiCapi_RingConstructSendmsg,
    UringApiCapi_RingConstructSendmsgZc,
    UringApiCapi_RingConstructAccept,
    UringApiCapi_RingConstructAcceptMultishot,
    UringApiCapi_RingConstructConnect,
    UringApiCapi_RingConstructPoll,
    UringApiCapi_RingConstructPollMultishot,
    UringApiCapi_RingConstructPollRemove,
    UringApiCapi_RingConstructCancel,
    UringApiCapi_RingConstructShutdown,
    UringApiCapi_RingConstructClose,
    UringApiCapi_RingConstructRead,
    UringApiCapi_RingConstructWrite,
