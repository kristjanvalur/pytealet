...
static PyMethodDef UringApiRing_methods[] = {
    ...
    {"submit_fdsize", _PyCFunction_CAST(UringApiRing_submit_fdsize), METH_VARARGS | METH_KEYWORDS,
     "Submit fd-only statx and return the byte length in completion.result on success."},
