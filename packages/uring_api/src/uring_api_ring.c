...
static PyMethodDef UringApiRing_methods[] = {
    ...
    {"submit_fstatx_size", _PyCFunction_CAST(UringApiRing_submit_fstatx_size), METH_VARARGS | METH_KEYWORDS,
     "Submit fd-only statx requesting STATX_SIZE (common file-size fast path)."},
    {"submit_statx_size", _PyCFunction_CAST(UringApiRing_submit_statx_size), METH_VARARGS | METH_KEYWORDS,
     "Submit path statx requesting STATX_SIZE (common file-size fast path)."},
