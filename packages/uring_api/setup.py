    ...
    ext_modules=[
        Extension(
            ...
            sources=[
                ...
                _uring_api_source("uring_api_fd_table.c"),
                _uring_api_source("uring_api_idle.c"),
                ...
                _uring_api_source("uring_api_wait_timing.c"),
            ],
            depends=[
                ...
                _uring_api_source("uring_api_fd_table.h"),
                _uring_api_source("uring_api_idle.h"),
                ...
                _uring_api_source("uring_api_wait_timing.h"),
            ],
